    ...
    return (
        <div>
            ...
            <section className="about-section">
                ...
                <p>DecentraZoo is a blockchain based strategy game where you can buy land and build a zoo with different and unique animals. 
                    You can create exhibits, buy and trade animals, visit other players Zoo's, and much more.</p>
            ...
            <section className="tag-section">
                <div className="tag-section-content">
                    <div className="tag-text">
                        ...
                        <p className='tag-details'>DecentraZoo offers a in-depth creation kit that allows you to create your Zoo with no limitations. 
                        Decorate your Zoo with a wide variety of items from the shop to create your very own
                        virtual decentralized Zoo.</p>
                    </div>
                    <img className='tag-img' src={building_screenshot} alt='building-ss'/>
                </div>

                <div className="tag-section-content">
                    <div className="tag-text">
                        <h3 className='tag-head'>Trade</h3>
                        <p className='tag-details'>Trade, Sell, or Buy items and animals on the DecentraZoo Marketplace. The Marketplace 
                        offers hundreds of unique items that you can use to decorate and expand upon your Zoo.
                        The Marketplace utilizes Ethereum smart contracts to ensure a safe and secure transaction process.</p>
                    </div>
                    <img className='tag-img' src={decentrazoo_marketplace} alt='marketplace'/>
                </div>

                <div className="tag-section-content">
                    <div className="tag-text">
                        <h4 className='tag-head'>Explore</h4>
                        <p className='tag-details'>What fun is a Zoo if no one can see it? DecentraZoo is a fully 
                        decentralized metaverse where land and items are owned by its users. Visit other players Zoo's and explore 
                        everything DecentraZoo has to offer!</p>
                    </div>
                    <img className='tag-img' src={decentrazoo_map} alt='dz-map'/>
                </div>
            </section>
